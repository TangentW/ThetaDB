...
FRAMEWORK_NAME="ThetaDBFFI"
BUILD_PROFILE="release"

WORKING_DIR="$( cd "$( dirname "${BASH_SOURCE[0]}" )" &> /dev/null && pwd )"
REPO_ROOT="$( dirname "$( dirname "$WORKING_DIR" )" )"
MANIFEST_PATH="$REPO_ROOT/thetadb-ffi/Cargo.toml"
...
cbindgen "$REPO_ROOT/thetadb-ffi" -l C -o "$COMMON/Headers/$FRAMEWORK_NAME.h"
